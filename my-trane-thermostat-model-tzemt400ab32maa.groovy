...
metadata {
	...
	definition (name: "My RCS Z-Wave Thermostat", namespace: "robbybx", author: "SmartThings")
    { 
		capability "Refresh"
		capability "Actuator"
        ...
        fingerprint mfr:"0010", prod:"0001", model:"0009", deviceJoinName: "TZ45R Thermostat"
	}
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"temperature", type: "thermostat", width: 6, height: 4, canChangeIcon: true, decoration: "flat"){
            ...
            tileAttribute("device.thermostatOperatingState", key: "OPERATING_STATE") {
                attributeState("idle", backgroundColor:"#8ea1a5")
...
//Thermostat Mode Control
        ...
        standardTile("modecool", "device.thermostatMode", width: 2, height: 2, inactiveLabel: false, decoration: "flat") {
            state "cool", label:'', action:"cool", backgroundColor:"#BC2323", icon:"st.thermostat.cool"
        }
        ...
        standardTile("thermostatOperatingState", "device.thermostatOperatingState", inactiveLabel: false, decoration: "flat", width: 3, height: 2) {
                state "cooling", icon: "st.thermostat.cool", backgroundColor:"#00A0DC"
                state "idle", label:'${currentValue}', backgroundColor:"#ffffff"
                state "heating", icon: "st.thermostat.heat", backgroundColor:"#ff0000"
		}
...
//Miscellaneous tiles used in this DH
		...
		main (["temperature"])
		details(["temperature", "heatLevelUp", "heatTile", "heatLevelDown", "coolLevelUp", "coolTile", "coolLevelDown", "thermoSliderControl", "statusL1Text", "statusL2Text", "fanon", "fanauto", "fancir", "modeheat", "modecool", "modeauto", "modeheatemrgcy", "modeoff", "refresh", "thermostatOperatingState"])
	}
}
